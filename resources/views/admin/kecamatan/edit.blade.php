            ...
            <div class="card-body">
              ...
              <form action="{{ route('kecamatan.update', $kecamatan->id) }}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $kecamatan->name) }}" required>
                  </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control @error('ongkir') is-invalid @enderror" name="ongkir" value="{{ old('ongkir', $kecamatan->ongkir) }}" required>
                    </div>
